		...
		if(is_array($this->lms_settings) && isset($this->lms_settings['general'])){
			...
			foreach($this->settings as $key=>$setting){
				switch($key){
					...
					break;
					case 'react_quizzes':
						if(!empty($this->settings['react_quizzes'])){
    ...
    */
	...
	function wplms_question_number_react($metabox){
		$metabox['vibe_question_number_react'] = array( // Text Input
			'label'	=> __('Number of questions per page','vibe-customtypes'), // <label>
			'desc'	=> __('Number of questions. to be loaded on one screen in quiz','vibe-customtypes'), // description
