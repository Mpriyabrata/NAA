        ...
        function wplms_quiz($quiz_id,$ajax=false,$in_course){
            ...
            $wplms_quiz_data = apply_filters('wplms_wplms_quiz_tab_settings',array(
                ...
                'translations'=>array(
                    ...
                    'select_option'=>_x('Select Option','','vibe'),
                    'course'=>_x('Course','','vibe'),
                    'quiz'=>_x('Quiz','','vibe'),
                    'true' => _x('True','','vibe'),
                    'false' => _x('False','','vibe'),
                    'start'=>_x('Start Quiz','','vibe'),
                    'continue'=>_x('Continue Quiz','','vibe'),
                    'submit'=>_x('Submit Quiz','','vibe'),
                    'reset'=>_x('Reset','','vibe'),
                    'start_quiz'=>_x('Start quiz','','vibe'),
                    'continue_quiz'=>_x('Start quiz','','vibe'),
                    'check_answer'=>_x('Check Answer','','vibe'),
                    'expired' => _x('Expired','','vibe'),
                    'days' => _x('Days','','vibe'),
                    'hours' => _x('Hours','','vibe'),
                    'minutes' => _x('Minutes','','vibe'),
                    'seconds' => _x('Seconds','','vibe'),
                    'correct_answer' => _x('Correct Answer','','vibe'),
                    'question' => _x('QUESTION','','vibe'),
                    'check_results' => _x('Check Results','','vibe'),
                    'save_quiz' => _x('Save Quiz','','vibe'),
                    'yes'=>_x('Yes','','vibe'),
                    'no'=>_x('No','','vibe'),
                    'start_quiz_confirm'=>_x('Do you really want to start the quiz?','','vibe'),
                    'submit_quiz_confirm'=>_x('Do you really want to submit the quiz?','','vibe'),
                    'unanswered_confirm'=>_x('You have some unanswered questions.','','vibe'),
                    'total_marks' => _x('Total Marks','','vibe')
            ...
            if($ajax){
                ...
                //development
                //wp_enqueue_script('wplms-quiz-js',plugins_url('/js/quiz/questions/dist/js/bundle.js',__FILE__),array('wp-element'),BP_COURSE_MOD_VERSION,true);
